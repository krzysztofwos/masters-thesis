...
This appendix records the commands used to reproduce the experimental outputs reported in this thesis. The workflow is Makefile-driven and uses the Python experiment driver under \texttt{scripts/automation/}.
