...
\section*{Donald Michie (1923--2007)}

Donald Michie was a key figure in early British artificial intelligence. During World War II he worked at Bletchley Park on high-level cipher problems. He later described how those years shaped his long-running interest in programming learning and intelligence into machines~\cite{michie_ieee_pioneers}. In the early 1960s---before routine access to computing---he developed MENACE, a physical reinforcement-learning system for noughts and crosses built from matchboxes and coloured beads~\cite{muggleton_2007_michie_obituary}. The point of MENACE was not ``performance'' in the modern benchmark sense, but the ability to make modelling assumptions and learning dynamics explicit and inspectable. Michie went on to build and lead Edinburgh's machine intelligence efforts and to edit the influential \emph{Machine Intelligence} volumes that recorded a formative period of AI research~\cite{michie_aiai_home}.
